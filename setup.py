...
#               'monitor will still work fine, but may run '
#               'a bit slower.\n')
#         CYTHON = False
#
# if CYTHON:
...
#         return module_names
#
#     package_names = ['monitor.common', 'monitor.core', 'monitor.db', 'monitor.middlewares']
#     ext_modules = [
#         Extension(
#             package + '.' + module,
...
setup(
    ...
    url='https://gitee.com/wu.jianjun/monitor',
    ...
    keywords='monitor automation restful rest api celery sqlalchemy falcon',
    ...
    entry_points={
        'console_scripts': [
           'talos_generator=monitor.tools.project:generate',
        ],
    },
)
